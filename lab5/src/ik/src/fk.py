...
def fk_service_client():
    ...
    temp = input("Comma Seperated List of 7 Joint Angles:")

    right_j0, right_j1, right_j2, right_j3,right_j4, right_j5, right_j6 = map(float,temp.split(','))

    joints.name = ['right_j0', 'right_j1', 'right_j2', 'right_j3','right_j4', 'right_j5', 'right_j6']
    joint_input = [right_j0, right_j1, right_j2, right_j3,right_j4, right_j5, right_j6]
